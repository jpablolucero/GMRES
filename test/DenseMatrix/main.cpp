...
{
  std::cout << std::endl ;
  std::cout << "DenseMatrix:DenseMatrix ------------- BEGIN ---------------" << std::endl ;
  std::cout << std::endl ;
  ...
  if ((res.first != 2) || (res.second > 100.*std::numeric_limits<T>::epsilon()))
    {
      std::cout << std::endl ;
      std::cout << "DenseMatrix:DenseMatrix ------------- FAIL ---------------" << std::endl ;
      std::cout << std::endl ;
      return false;
    }

  std::cout << std::endl ;
  std::cout << "DenseMatrix:DenseMatrix ------------- SUCCESS ---------------" << std::endl ;
  std::cout << std::endl ;
...
int main()
{
  if (DenseMatrix<float>()&&DenseMatrix<double>()&&DenseMatrix<long double>())
    {
      std::cout << std::endl ;
      std::cout << "DenseMatrix ------------- SUCCESS ---------------" << std::endl ;
      std::cout << std::endl ;
      return 0;
    }
  else
    {
      std::cout << std::endl ;
      std::cout << "DenseMatrix ------------- FAIL ---------------" << std::endl ;
      std::cout << std::endl ;
      return -1;
    }
}
